        ...
        <nav>
            <div class="container mx-auto px-6 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <a class="flex items-center py-1 px-3 tracking-wide bg-blue-700 text-white font-medium rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600" href="https://github.com/merakiui/merakiui" target="_blink">
                        <svg class="h-5 w-5 fill-current" viewBox="0 0 30 30">
                        ...
                        <span class="ml-2 text-sm" v-text="stargazers_count"></span>
                    </a>
                </div>
            </div>
        </nav>
...
export default {
    ...
    beforeMount() {
        this.fetchStargazersCount();
    },

    methods: {
        fetchStargazersCount() {
            axios.get("https://api.github.com/repos/merakiui/merakiui")
            .then(response => this.stargazers_count = response.data.stargazers_count);
        }
    }
}
</script>
